...
def boosting_bbvi():
    ...
    for t in range(1, n_iterations + 1):
        ...
        for step in range(n_steps):
            print('Step: ', step)
            # approximation_log_prob = trace(block(wrapped_approximation, expose_fn=lambda site: 'obs_' in site['name'])).get_trace(data).log_prob_sum()
